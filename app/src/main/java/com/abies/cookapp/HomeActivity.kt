package com.abies.cookapp

import android.content.Intent
import android.os.Bundle
import androidx.recyclerview.widget.LinearLayoutManager
import com.abies.cookapp.adapter.MainCategoryAdapter
import com.abies.cookapp.adapter.SubCategoryAdapter
import com.abies.cookapp.database.RecipeDatabase
import com.abies.cookapp.entities.CategoryItems
import com.abies.cookapp.entities.MealsItems
...
class HomeActivity : BaseActivity() {
    ...
    private fun getMealDataFromDb(categoryName:String){
        tvCategory.text = "$categoryName Meals"
        launch {
            this.let {
